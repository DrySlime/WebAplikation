...
FOR %%x IN ("D:\SherwoodMan\Uni\3.Semester\Softwareprojekt I\WebAplikation\XAMPP\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=D:\SherwoodMan\Uni\3.Semester\Softwareprojekt I\WebAplikation\XAMPP\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=D:\SherwoodMan\Uni\3.Semester\Softwareprojekt I\WebAplikation\XAMPP\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=D:\SherwoodMan\Uni\3.Semester\Softwareprojekt I\WebAplikation\XAMPP\php\php.exe"
GOTO :INSTALLED
