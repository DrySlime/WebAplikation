        ...
        <div class="loginregister_wrapper">
            ...
            <form action="includes/signup_include.php" method="post">
                <div class="form_container">
                    <label for="username"></label><input type="text" name="username" id="username" placeholder="Benutzername" value="<?php echo $uid ?>" required>
                    <label for="name"></label><input type="text" name="name" id="name" placeholder="Vorname" value="<?php echo $pre ?>" required>
                    <label for="surname"></label><input type="text" name="surname" id="surname" placeholder="Nachname" value="<?php echo $sur ?>" required>
                    <label for="email"></label><input type="text" name="email" id="email" placeholder="Email" value="<?php echo $mail ?>" required>
