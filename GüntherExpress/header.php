            ...
            <ul id="navbar">
                ...
                <li>
                    <div class="navbar_dropdown">
                        <button onclick="showCategories()" class="dropbtn">Kategorien<i
                                    class="material-symbols-outlined" style="pointer-events: none;">expand_more</i>
                        </button>
                ...
                <?php } ?>
                <li>
                    <button class="dropbtn" onclick="showWarenkorb()"><i class="material-symbols-outlined"
                                                                         style="pointer-events: none; font-variation-settings: 'FILL' 1, 'wght' 400, 'GRAD' 0, 'opsz' 48;">shopping_cart</i>
                    </button>
                </li>
            </ul>
        </div>
